...
"""
This module has functions to assist with the naming of input and output
files.
"""


def get_input_output_paths_from_argv_or_env():
    """
...
def landbosse_output_dir():
    ...
    """
    _, output_path = get_input_output_paths_from_argv_or_env()
    return output_path
...
def landbosse_input_dir():
    ...
    str
        The input directory.
    """
    input_path, _ = get_input_output_paths_from_argv_or_env()
    return input_path
